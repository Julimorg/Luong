...
// Đường dẫn logo icon hiển thị phía trên hero — đổi lại nếu path thực tế khác
const HERO_LOGO_SRC = "/icon/icon_black_background.png";
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16 w-full">
        ...
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
          ...
          <img
            src={HERO_LOGO_SRC}
            alt="VietHungSolar"
            className="h-20 sm:h-24 w-auto mb-6 animate-[fadeInUp_0.7s_ease_both]"
          />
          <div className="flex items-center justify-center gap-2 mb-5 animate-[fadeInUp_0.8s_0.05s_ease_both]">
          ...
          <div className="flex flex-wrap justify-center gap-3 animate-[fadeInUp_0.9s_0.3s_ease_both]">
            <Button
              variant="contained"
